export const messagesEn = {
  ...
  "about.languages.spanish": "Spanish (Native)",
  "about.languages.catalan": "Catalan (Native)",
  "about.languages.english": "English (Fluent)",
  "about.languages.italian": "Italian (Conv.)",
  "about.education.title": "Education",
  "about.education.master.degree": "Master Software Architect",
  ...
  "about.education.bachelor.degree": "Bachelor DevOps Application Developer",
  "about.education.bachelor.school": "EPSI",
  "about.education.bachelor.location": "Toulouse",
  "about.education.bachelor.period": "2022 — 2023",
  "about.education.bachelor.distinction": "With honors from the jury",
  "about.education.bac2.degree": "Web & Mobile Developer",
  "about.education.bac2.school": "SIMPLON",
  "about.education.bac2.location": "Toulouse",
  "about.education.bac2.period": "2021 — 2022",
  "about.education.bac.degree": "Science & Technology Baccalaureate",
  "about.education.bac.school": "IES Salvador Espriu",
  "about.education.bac.location": "Girona, Spain",
  ...
  "experience.openWebsite": "Open website",
  ...
  "howItsMade.overview.description":
    "This portfolio was built from scratch using modern web technologies to create a smooth, interactive experience. Every animation, transition, and interaction was carefully crafted to showcase both technical skills and attention to detail.",
  ...
  "howItsMade.animations.items":
    "Scroll-triggered animations using GSAP ScrollTrigger for dynamic content reveal;Parallax effects on hero section and project titles for depth perception;Stagger animations on project cards for sequential appearance;3D tilt effects on project cards using custom TiltCard component;Smooth page transitions with Framer Motion variants;Micro-interactions on buttons and links with hover/tap states;Floating badge animation in hero section with continuous motion;Timeline-based animations for experience cards;Magnetic cursor effects on interactive elements",
  "howItsMade.features.title": "Key Features",
  "howItsMade.features.items":
    "Fully responsive design that works seamlessly on mobile, tablet, and desktop;Dark-themed UI with glassmorphism effects and subtle gradients;Bilingual support with instant language switching (EN/FR);Dynamic project pages with detailed case studies;Smooth scroll with Lenis for enhanced user experience;Optimized performance with Next.js Image component and lazy loading;SEO-friendly with proper meta tags and Open Graph protocol;Accessible UI with proper ARIA labels and keyboard navigation;Type-safe routing with Next.js App Router;Component-based architecture for maintainability",
  "howItsMade.performance.title": "Performance & Optimization",
  "howItsMade.performance.description":
    "Built with performance in mind, this portfolio uses Next.js server components for fast initial page loads, code splitting for optimal bundle sizes, and optimized images with automatic lazy loading. Animations are GPU-accelerated using transform and opacity properties to maintain 60fps.",
  ...
  "project.rlSuite.description":
    "Comprehensive reinforcement learning project implementing Q-Learning, SARSA, and Deep Q-Network (DQN) algorithms across multiple game environments including classic Gymnasium and Atari games.",
  ...
  "project.myActual.description":
    "Comprehensive web and mobile application serving thousands of temporary workers, candidates, and agencies across France. Manages missions, contracts, documents, applications, and agency communications with real-time synchronization across platforms.",

export const messagesEn = {
  ...
  "about.languages.items":
    "🇫🇷 French (Native);🇦🇪 Arabic (Native);🇪🇸 Spanish (Native);🇪🇸 Catalan (Native);🇬🇧 English (Fluent);🇮🇹 Italian (Conv.)",
  "about.education": "Education",
  "about.education.items":
    "• Master Software Architect - EPITECH;• Bachelor DevOps - EPSI (Honors);• Web Developer - SIMPLON",
